    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-[#111]/80 backdrop-blur-lg">
      <nav className="container mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a href="/CV_Muhammad Rayhan Denel_ATS.pdf" target="_blank" className="bg-blue-600 text-white font-semibold px-4 py-2 rounded-md hover:bg-blue-700 transition-colors text-sm">
            View Resume
          </a>
